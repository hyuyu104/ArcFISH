...
## Local installation and data preparation
...
If you plan to do download all the data, the file `data/data.json` lists the ID for each data from ENCODE or 4DN data portal. To automatically download all data, first need to create a new access key for 4DN.
